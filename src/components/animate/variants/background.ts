...
export const varBgColor = (props: IBGVariant) => {
  const {
...
export const varBgKenburns = (props: Pick<IBGVariant, "duration" | "ease">) => {
  const { duration = 5, ease = "easeOut" } = props;
...
export const varBgPan = (props: IBGVariant) => {
  const {
